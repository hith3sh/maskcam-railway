...
# light checker starts

        # Access the frame data as a NumPy array
...
# light checker ends here


#grass checker starts
        # Get the frame surface
        surface = pyds.get_nvds_buf_surface(hash(gst_buffer), frame_meta.batch_id)
        imageFrame = np.array(surface, copy=False, order='C')
        ...
        # Write the modified frame back into the GstBuffer
        np.copyto(surface, imageFrame)
